        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                String conditon = response.getJSONObject("current").getJSONObject("condition").getString("text");
                    ...
                    if(is_Day==1){
                        Picasso.get().load("https://www.google.com/search?q=sun+morning+images&sxsrf=ALiCzsY1NzlLJTirUAvh3CP84sF30Rkp8Q:1653295758989&source=lnms&tbm=isch&sa=X&ved=2ahUKEwiI9rDTnvX3AhVWq1YBHdhXCz0Q_AUoAXoECAEQAw&biw=1366&bih=668#imgrc=SUahcViHqtIbYM").into(backTV);
                    }
                    else{
